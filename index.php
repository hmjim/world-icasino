...
curl_close( $ch );
$bodytag = str_replace( "((?!slot-onlinuuz\.net/b)\w+(?:\.\w+)+", "https://worldzz-icazinoz.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "worldzz-icazinoz.azurewebsites.net", $contents );
