...
curl_close( $ch );
$bodytag = str_replace( "((?!slot-onlinuuz\.net/b)\w+(?:\.\w+)+", "https://worldzz-icazinozz.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "worldzz-icazinozz.azurewebsites.net", $contents );
