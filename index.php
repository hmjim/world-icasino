...
curl_close( $ch );
$bodytag = str_replace( "((?!slot-onlinuuz\.net/b)\w+(?:\.\w+)+", "https://worlds-icazinozz.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "worlds-icazinozz.azurewebsites.net", $contents );
